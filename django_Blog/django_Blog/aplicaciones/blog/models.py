...
class Autor(models.Model):
    ...
    twiter = models.URLField('twiter', blank=True, null=True)
...
class Post(models.Model):
    id = models.AutoField(primary_key = True)
    titulo = models.CharField('Titulo post',max_length=255, blank=False, null=False)
    #Por esto accedemos a cada una de las instancias del modelo post
    slug = models.CharField('Slug', max_length=100, blank=False, null=False)
    descripcion = models.CharField('Titulo post',max_length=500, blank=False, null=False)
